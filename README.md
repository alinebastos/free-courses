...
> Mais do que um amontoado de links, esta é uma seleção do que julgamos ser algumas das melhores oportunidades de aprendizado
> que você vai encontrar gratuitamente.


## 📕 Index - Índice
📌 [Agile](#-agile)<br>
📌 [Backend](#-backend)<br>
📌 [Data Science - Ciência de Dados](#-data-science---ciência-de-dados)<br>
📌 [Frontend](#-frontend)<br>
📌 [FullStack](#-fullstack)<br>
📌 [Git and Github - Git e Github](#-git-and-github---git-e-github)<br>
📌 [Infrastructure - Infraestrutura](#-infrastructure---infraestrutura)<br>
📌 [Programming - Lógica de Programação](#-programming---lógica-de-programação)<br>
📌 [Mobile](#-mobile)<br>
📌 [Cyber Security - Segurança da Informação](#cyber-security---segurança-da-informação)<br>
...
#### Various courses from esteemed institutions - Diversos cursos em instituições renomadas
| Link | Language - Idioma |
| ----- | :-----: |
...
#### Fullstack Web Development - Desenvolvimento Web FullStack
| Link | Language - Idioma |
| ----- | :-----: |
...
This project does have a license. For more details, see [LICENSE](LICENSE).

Este projeto está licenciado. Abra o arquivo [LICENSE](LICENSE) para mais detalhes.<br>

<br>[⬆ Back to index - Voltar ao índice](#-índice)<br>
